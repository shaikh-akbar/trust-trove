  ...
  return (
    <div className="bg-[var(--surface-soft)]">
      <PolicyHero
        ...
        description="By visiting the GoModexa website, browsing products, or placing an order, you agree to these service terms, along with the related policy pages published on this website."
      />
      ...
      <div className="mx-auto max-w-5xl space-y-6 px-4 pb-16 sm:px-6 lg:px-8 lg:pb-20 py-5">
        <PolicySection title="Use of the website">
          <PolicyBulletList
            items={[
              ...
              "You may not use GoModexa products or services for unlawful or unauthorized purposes.",
        ...
        <PolicySection title="General service conditions">
          <PolicyBulletList
            items={[
              "GoModexa reserves the right to refuse service to anyone for any reason at any time.",
        ...
        <PolicySection title="Products, pricing, and orders">
          <PolicyBulletList
            items={[
              ...
              "GoModexa aims to display product colors and images as accurately as possible, but screen variations may affect appearance.",
              "GoModexa may limit, refuse, or cancel orders at its discretion, including for suspected reseller, duplicate, or high-risk orders.",
        ...
        <PolicySection title="User submissions and prohibited conduct">
          <PolicyBulletList
            items={[
              "If you send comments, feedback, suggestions, or similar submissions, GoModexa may use them without obligation to compensate or respond.",
        ...
        <PolicySection title="Liability and legal scope">
          <PolicyBulletList
            items={[
              "GoModexa does not guarantee uninterrupted, error-free, or always-available website service.",
              "All use of the website and services is at the customer’s own risk, subject to applicable law.",
              "These terms are governed by the laws of India.",
              "GoModexa may update these terms from time to time, and continued website use after updates implies acceptance of the revised terms.",
            ]}
          />
        </PolicySection>

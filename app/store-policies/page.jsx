  ...
  return (
    <div className="bg-[var(--surface-soft)] ">
      <PolicyHero
        ...
        description="These quick answers explain how shopping, account access, order tracking, security, payments, and support work across GoModexa."
      />
      ...
      <div className="mx-auto max-w-5xl space-y-6 px-4 pb-16 sm:px-6 lg:px-8 lg:pb-20 py-5">
        <PolicySection title="Accounts and orders">
          <PolicyBulletList
            items={[
              "You do not need to create an account just to browse the GoModexa store.",
        ...
        <PolicySection title="Security and privacy">
          <PolicyBulletList
            items={[
              "Ordering on GoModexa is designed to be secure.",
        ...
        <PolicySection title="Shipping support">
          <PolicyBulletList
            items={[
              "GoModexa serves a broad delivery network across India, subject to serviceable pin codes.",
        ...
        <PolicySection title="Payments">
          <PolicyBulletList
            items={[
              "GoModexa accepts Cards, UPI, Net Banking, and Wallets.",

...
const SHIPPING_POLICY_DESCRIPTION =
  "Read the GoModexa shipping policy, dispatch expectations, delivery timelines, and order support guidance.";

export const metadata = buildMetadata({
  title: "Shipping Policy",
  path: "/shipping-policy",
  description: SHIPPING_POLICY_DESCRIPTION,
  keywords: ["shipping policy", "delivery information", "GoModexa shipping"],
});
  ...
  return (
    <div className="bg-[var(--surface-soft)]">
      ...
      <PolicyHero
        ...
        description="This page explains how GoModexa processes, ships, and delivers orders across India, including shipping timelines, serviceability, and tracking expectations."
      />
      ...
      <div className="mx-auto max-w-5xl space-y-6 px-4 pb-16 sm:px-6 lg:px-8 lg:pb-20 py-5">
        <PolicySection title="Processing and dispatch timelines">
          <PolicyBulletList
            items={[
              "GoModexa generally processes and ships orders on the next business day.",
        ...
        <PolicySection title="Delivery timelines">
          <PolicyBulletList
            items={[
              ...
              "GoModexa guarantees dispatch within the stated internal processing timeline, but courier transit is handled by third-party delivery partners.",
            ]}
          />
        </PolicySection>
        ...
        <PolicySection title="Serviceability and shipment handling">
          <PolicyBulletList
            items={[
              ...
              "To ensure fast and safe delivery, GoModexa ships through reputed courier agencies only.",
